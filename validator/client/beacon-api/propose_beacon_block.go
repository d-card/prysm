...
func marshallBeaconBlockPhase0(block *ethpb.SignedBeaconBlock) ([]byte, error) {
	signedBeaconBlockJson := &structs.SignedBeaconBlock{
		...
		Message: &structs.BeaconBlock{
			...
			ProposerIndex: httputil.Uint64ToString(block.Block.ProposerIndex),
			Slot:          httputil.Uint64ToString(block.Block.Slot),
		...
		Message: &structs.BeaconBlockBellatrix{
			...
			Body: &structs.BeaconBlockBodyBellatrix{
				...
				ExecutionPayload: &structs.ExecutionPayload{
					...
					BlockNumber:   httputil.Uint64ToString(block.Block.Body.ExecutionPayload.BlockNumber),
					GasLimit:      httputil.Uint64ToString(block.Block.Body.ExecutionPayload.GasLimit),
					GasUsed:       httputil.Uint64ToString(block.Block.Body.ExecutionPayload.GasUsed),
					Timestamp:     httputil.Uint64ToString(block.Block.Body.ExecutionPayload.Timestamp),
		...
		Message: &structs.BlindedBeaconBlockBellatrix{
			...
			Body: &structs.BlindedBeaconBlockBodyBellatrix{
				...
				ExecutionPayloadHeader: &structs.ExecutionPayloadHeader{
					...
					BlockNumber:      httputil.Uint64ToString(block.Block.Body.ExecutionPayloadHeader.BlockNumber),
					GasLimit:         httputil.Uint64ToString(block.Block.Body.ExecutionPayloadHeader.GasLimit),
					GasUsed:          httputil.Uint64ToString(block.Block.Body.ExecutionPayloadHeader.GasUsed),
					Timestamp:        httputil.Uint64ToString(block.Block.Body.ExecutionPayloadHeader.Timestamp),
