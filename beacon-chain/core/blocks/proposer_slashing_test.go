...
func TestProcessProposerSlashings_UnmatchedHeaderSlots(t *testing.T) {
	...
	_, _, err := blocks.ProcessProposerSlashings(context.Background(), beaconState, b.Block.Body.ProposerSlashings, v.SlashValidator, v.ExitInformation(beaconState))
...
func TestProcessProposerSlashings_AppliesCorrectStatus(t *testing.T) {
	...
	newState, _, err := blocks.ProcessProposerSlashings(context.Background(), beaconState, block.Block.Body.ProposerSlashings, v.SlashValidator, v.ExitInformation(beaconState))
	require.NoError(t, err)
